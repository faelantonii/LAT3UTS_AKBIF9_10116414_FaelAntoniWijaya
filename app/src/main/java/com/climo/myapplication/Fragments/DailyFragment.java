...
public class DailyFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dailyList.add(new DailyActivityModel("Kuliah", R.drawable.ic_school_black_24dp));
        dailyList.add(new DailyActivityModel("Makan", R.drawable.ic_directions_walk_black_24dp));
        dailyList.add(new DailyActivityModel("Menonton Film", R.drawable.ic_slideshow_black_24dp));
        dailyList.add(new DailyActivityModel("Tidur", R.drawable.ic_menu_camera));
    }
